          ...
          <div className="background">
            ...
            <div className="banner">
              <Carousel
                ...
                timeout={700}
              >
                <img src={img7} alt="6" style={{ width: "100%",height: "27rem" }} />
                <img src={img5} alt="5" style={{ width: "100%" ,height: "27rem" }} />
                <img src={img6} alt="6" style={{ width: "100%" ,height: "27rem" }} />
                <img src={img1} alt="1" style={{ width: "100%" ,height: "27rem" }} />
                <img src={img2} alt="2" style={{ width: "100%" ,height: "27rem"}} />
                <img src={img3} alt="2" style={{ width: "100%" ,height: "27rem"}} />
                <img src={img4} alt="4" style={{ width: "100%" ,height: "27rem"}} />
                

                <img src={img8} alt="6" style={{ width: "100%" ,height: "27rem" }} />
              </Carousel>
            </div>
